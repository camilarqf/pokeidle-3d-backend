...
public class MoveRemovidoDoMovesetSpeciesEvent extends DomainEvent {
    ...
    private MoveRemovidoDoMovesetSpeciesEvent(
    ...
    public static MoveRemovidoDoMovesetSpeciesEvent criar(
            CorrelationKey correlationKey,
            Long speciesId,
            Long moveId,
            MoveLearnMethod learnMethod,
        ...
        return new MoveRemovidoDoMovesetSpeciesEvent(correlationKey, speciesId, moveId, learnMethod, levelLearnedAt);
    }
