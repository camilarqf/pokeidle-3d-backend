...
public class SpeciesCreatedEvent extends DomainEvent {
    ...
    public static SpeciesCreatedEvent criar(
            CorrelationKey correlationKey,
            Integer pokedexNumber,
            String name,
            PokemonType primaryType,
        ...
        return new SpeciesCreatedEvent(correlationKey, pokedexNumber, name, primaryType, secondaryType);
    }
