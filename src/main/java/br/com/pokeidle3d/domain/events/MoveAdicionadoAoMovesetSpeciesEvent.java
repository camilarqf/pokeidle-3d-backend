...
public class MoveAdicionadoAoMovesetSpeciesEvent extends DomainEvent {
    ...
    private MoveAdicionadoAoMovesetSpeciesEvent(
    ...
    public static MoveAdicionadoAoMovesetSpeciesEvent criar(
            CorrelationKey correlationKey,
            Long speciesId,
            Long moveId,
            MoveLearnMethod learnMethod,
        ...
        return new MoveAdicionadoAoMovesetSpeciesEvent(correlationKey, speciesId, moveId, learnMethod, levelLearnedAt);
    }
