...
public class MoveAddedToSpeciesMovesetEvent extends DomainEvent {
    ...
    private MoveAddedToSpeciesMovesetEvent(
    ...
    public static MoveAddedToSpeciesMovesetEvent criar(
            CorrelationKey correlationKey,
            Long speciesId,
            Long moveId,
            MoveLearnMethod learnMethod,
        ...
        return new MoveAddedToSpeciesMovesetEvent(correlationKey, speciesId, moveId, learnMethod, levelLearnedAt);
    }
