...
import br.com.pokeidle3d.application.events.DomainEventPublisher;
...
@Component
public class SpringDomainEventUnitOfWork implements DomainEventUnitOfWork {

    private final DomainEventPublisher publicadorEventosDominio;
    private final ThreadLocal<List<AggregateComId>> aggregates = ThreadLocal.withInitial(ArrayList::new);

    public SpringDomainEventUnitOfWork(DomainEventPublisher publicadorEventosDominio) {
